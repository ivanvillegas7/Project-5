...
# Function that takes care of updating the Re0 data and other things for each frame
def animation(i):
...
# Save the animation (either with .mp4 or .gif)
...
# Function that takes care of updating the Im0 data and other things for each frame
def animation(i):
    # Normalize the colour scale to the current frame?
...
# We create a cube, and fill it with a txt that contains the data of the probability function for 1 slit
p = pa.cube()
...
# Function that takes care of updating the p0 data and other things for each frame
def animation(i):
    # Normalize the colour scale to the current frame?
...
# Save the animation (either with .mp4 or .gif)
anim.save('p_1slit_animation.gif', writer="ffmpeg", bitrate=-1, fps=30)

# We create a cube, and fill it with a txt that contains the data of the probability function for 2 slits
p = pa.cube()
...
# Save the animation (either with .mp4 or .gif)
anim.save('p_2slits_animation.gif', writer="ffmpeg", bitrate=-1, fps=30)

# We create a cube, and fill it with a txt that contains the data of the probability function for 3 slits
p = pa.cube()
...
# Save the animation (either with .mp4 or .gif)
anim.save('p_3slits_animation.gif', writer="ffmpeg", bitrate=-1, fps=30)
